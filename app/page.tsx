...
import { Menu, X, Phone, Mail, MapPin, Clock, Facebook, Instagram, MessageCircle } from 'lucide-react';
  ...
  const products = [
    {
      ...
      description: 'Traditional sourdough bread with a perfect crust and tender crumb',
    ...
    },
    {
      ...
      description: 'Classic apple pie made with fresh apples and grandmother\'s recipe',
      image: 'https://images.pexels.com/photos/7937035/pexels-photo-7937035.jpeg?auto=compress&cs=tinysrgb&w=600'
    },
    {
    ...
    <div className="min-h-screen bg-amber-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-amber-900 font-dancing-script">A Camponesa</h1>
            </div>
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-8">
                ...
                <a href="#products" className="text-amber-900 hover:text-amber-700 transition-colors">Products</a>
                <a href="#gallery" className="text-amber-900 hover:text-amber-700 transition-colors">Gallery</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a href="#products" className="block px-3 py-2 text-amber-900 hover:text-amber-700">Products</a>
              <a href="#gallery" className="block px-3 py-2 text-amber-900 hover:text-amber-700">Gallery</a>
              <a href="#contact" className="block px-3 py-2 text-amber-900 hover:text-amber-700">Contact</a>
              <div className="px-3 py-2">
                <Button className="w-full bg-amber-600 hover:bg-amber-700 text-white">Order Now</Button>
              </div>
            </div>
          </div>
        )}
      ...
      <section id="home" className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-dancing-script mb-6">A Camponesa</h1>
          <p className="text-xl md:text-2xl mb-8 font-light">
            Bringing the taste of home to your table
          </p>
          <p className="text-lg md:text-xl mb-10 opacity-90 max-w-2xl mx-auto">
            Experience the warmth of traditional baking with our handcrafted breads, pastries, and sweets made from time-honored family recipes
          </p>
      ...
      <section id="about" className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-dancing-script text-amber-900 mb-6">Our Story</h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                A Camponesa was born from a love of traditional baking and the desire to bring authentic, homemade flavors to our community. Our story begins in the countryside, where generations of bakers perfected recipes that have been passed down through families.
              </p>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Every morning, we wake before dawn to knead dough, shape loaves, and fill our ovens with the aromatic promise of fresh bread. We use only the finest ingredients, sourced locally when possible, and never compromise on quality or tradition.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                When you step into our bakery, you're not just buying bread – you're becoming part of our extended family, sharing in the comfort and joy that comes from food made with love.
              </p>
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-amber-100 p-6 rounded-lg shadow-lg">
                <p className="text-amber-900 font-semibold text-lg">Est. 1985</p>
      ...
      <section id="products" className="py-16 md:py-24 bg-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-dancing-script text-amber-900 mb-4">Our Specialties</h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Each product is lovingly crafted using traditional methods and the finest ingredients
            </p>
          </div>
      ...
      <section id="gallery" className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-dancing-script text-amber-900 mb-4">Gallery</h2>
            <p className="text-xl text-gray-700">A glimpse into our bakery and the magic we create daily</p>
          </div>
      ...
      <section id="contact" className="py-16 md:py-24 bg-amber-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-dancing-script text-amber-900 mb-4">Get In Touch</h2>
            <p className="text-xl text-gray-700">We'd love to hear from you and help with your bakery needs</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <Card className="bg-white shadow-lg">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-semibold text-amber-900 mb-6">Visit Our Bakery</h3>
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      <MapPin className="text-amber-600 mt-1" size={20} />
                      <div>
                        <p className="font-medium text-gray-900">Address</p>
                        <p className="text-gray-600">123 Countryside Lane<br />Bakery Village, BV 12345</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
              ...
              <Card className="bg-amber-600 text-white shadow-lg">
                <CardContent className="p-8 text-center">
                  <h3 className="text-2xl font-semibold mb-4">Order via WhatsApp</h3>
                  <p className="mb-6">Get your fresh baked goods delivered or ready for pickup</p>
      ...
      <section className="py-16 md:py-24 bg-amber-900 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8 opacity-90">
            Don't wait – our fresh baked goods are available for order today. Experience the difference that traditional baking makes.
          </p>
          <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
            <Button size="lg" className="bg-amber-600 hover:bg-amber-500 text-white px-8 py-3 text-lg">
              Place Your Order
            </Button>
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-amber-900 px-8 py-3 text-lg">
      ...
      <footer className="bg-amber-950 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-amber-100 mb-4 max-w-md">
                Your neighborhood artisanal bakery, committed to bringing you the finest traditional baked goods made with love and expertise.
              </p>
          ...
          <div className="border-t border-amber-800 mt-8 pt-8 text-center text-amber-200">
            <p>&copy; 2024 A Camponesa Bakery. All rights reserved. | Artisanal breads, traditional pastries, homemade sweets</p>
          </div>
        </div>
      </footer>
    </div>
